...
class Page3 extends StatefulWidget {  @override
...
class _HomeState extends State<Page3> {
  ...
  loadmodel()async{
    await Tflite.loadModel(model: "assets/model_unquant3.tflite",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Cutting",style: TextStyle(color: Colors.redAccent),),

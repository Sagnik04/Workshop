...
class Page2 extends StatefulWidget {  @override
...
class _HomeState extends State<Page2> {
  ...
  loadmodel()async{
    await Tflite.loadModel(model: "assets/model_unquant2.tflite",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Marking",style: TextStyle(color: Colors.redAccent),),

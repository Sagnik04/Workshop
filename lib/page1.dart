...
class Page1 extends StatefulWidget {  @override
...
class _HomeState extends State<Page1> {
  ...
  loadmodel()async{
    await Tflite.loadModel(model: "assets/model_unquant1.tflite",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Measurement",style: TextStyle(color: Colors.redAccent),),
